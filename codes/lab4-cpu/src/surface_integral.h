...
private:
	...
	double *quad_weight_g;
	double *wave_theta_cache, *wave_cos_cache, *wave_sin_cache;
	int wave_cache_spinw, wave_cache_maxl, wave_cache_NN;
	int wave_cache_Nmin, wave_cache_Nmax, wave_cache_lpsy;
	void ensure_wave_angular_cache(int spinw, int maxl, int NN,
