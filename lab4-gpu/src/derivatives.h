...
__device__ __forceinline__ void d_fderivs_point(
    ...
    *fz = ZEO;
    ...
    double h_im2 = fh(ai_m2,j,k), h_im1 = fh(ai_m1,j,k), h_ip1 = fh(ai_p1,j,k), h_ip2 = fh(ai_p2,j,k);
...
__device__ __forceinline__ void d_fdderivs_point(
    ...
    *fxy = ZEO; *fxz = ZEO; *fyz = ZEO;
    ...
    double h_im2 = fh(ai_m2,j,k), h_im1 = fh(ai_m1,j,k), h_000 = fh(i,j,k), h_ip1 = fh(ai_p1,j,k), h_ip2 = fh(ai_p2,j,k);
    ...
    *fzz = m4 * Fdzdz * (-h_km2 + F16*h_km1 - F30*h_000 - h_kp2 + F16*h_kp1)
    ...
    double h_im2_jm2 = fh(ai_m2,aj_m2,k), h_im1_jm2 = fh(ai_m1,aj_m2,k), h_ip1_jm2 = fh(ai_p1,aj_m2,k), h_ip2_jm2 = fh(ai_p2,aj_m2,k);
    double r_fxy_0 = (h_im2_jm2 - F8*h_im1_jm2 + F8*h_ip1_jm2 - h_ip2_jm2);
    double h_im2_jm1 = fh(ai_m2,aj_m1,k), h_im1_jm1 = fh(ai_m1,aj_m1,k), h_ip1_jm1 = fh(ai_p1,aj_m1,k), h_ip2_jm1 = fh(ai_p2,aj_m1,k);
    double r_fxy_1 = (h_im2_jm1 - F8*h_im1_jm1 + F8*h_ip1_jm1 - h_ip2_jm1);
    double h_im2_jp1 = fh(ai_m2,aj_p1,k), h_im1_jp1 = fh(ai_m1,aj_p1,k), h_ip1_jp1 = fh(ai_p1,aj_p1,k), h_ip2_jp1 = fh(ai_p2,aj_p1,k);
    double r_fxy_2 = (h_im2_jp1 - F8*h_im1_jp1 + F8*h_ip1_jp1 - h_ip2_jp1);
    double h_im2_jp2 = fh(ai_m2,aj_p2,k), h_im1_jp2 = fh(ai_m1,aj_p2,k), h_ip1_jp2 = fh(ai_p1,aj_p2,k), h_ip2_jp2 = fh(ai_p2,aj_p2,k);
    ...
    *fxy = m4 * Fdxdy * (r_fxy_0 - F8*r_fxy_1 + F8*r_fxy_2 - r_fxy_3)
    ...
    double h_im2_km2 = fh(ai_m2,j,ak_m2), h_im1_km2 = fh(ai_m1,j,ak_m2), h_ip1_km2 = fh(ai_p1,j,ak_m2), h_ip2_km2 = fh(ai_p2,j,ak_m2);
    double r_fxz_0 = (h_im2_km2 - F8*h_im1_km2 + F8*h_ip1_km2 - h_ip2_km2);
    double h_im2_km1 = fh(ai_m2,j,ak_m1), h_im1_km1 = fh(ai_m1,j,ak_m1), h_ip1_km1 = fh(ai_p1,j,ak_m1), h_ip2_km1 = fh(ai_p2,j,ak_m1);
    double r_fxz_1 = (h_im2_km1 - F8*h_im1_km1 + F8*h_ip1_km1 - h_ip2_km1);
    double h_im2_kp1 = fh(ai_m2,j,ak_p1), h_im1_kp1 = fh(ai_m1,j,ak_p1), h_ip1_kp1 = fh(ai_p1,j,ak_p1), h_ip2_kp1 = fh(ai_p2,j,ak_p1);
    double r_fxz_2 = (h_im2_kp1 - F8*h_im1_kp1 + F8*h_ip1_kp1 - h_ip2_kp1);
    double h_im2_kp2 = fh(ai_m2,j,ak_p2), h_im1_kp2 = fh(ai_m1,j,ak_p2), h_ip1_kp2 = fh(ai_p1,j,ak_p2), h_ip2_kp2 = fh(ai_p2,j,ak_p2);
    ...
    *fxz = m4 * Fdxdz * (r_fxz_0 - F8*r_fxz_1 + F8*r_fxz_2 - r_fxz_3)
    ...
    double h_jm2_km2 = fh(i,aj_m2,ak_m2), h_jm1_km2 = fh(i,aj_m1,ak_m2), h_jp1_km2 = fh(i,aj_p1,ak_m2), h_jp2_km2 = fh(i,aj_p2,ak_m2);
    double r_fyz_0 = (h_jm2_km2 - F8*h_jm1_km2 + F8*h_jp1_km2 - h_jp2_km2);
    double h_jm2_km1 = fh(i,aj_m2,ak_m1), h_jm1_km1 = fh(i,aj_m1,ak_m1), h_jp1_km1 = fh(i,aj_p1,ak_m1), h_jp2_km1 = fh(i,aj_p2,ak_m1);
    double r_fyz_1 = (h_jm2_km1 - F8*h_jm1_km1 + F8*h_jp1_km1 - h_jp2_km1);
    double h_jm2_kp1 = fh(i,aj_m2,ak_p1), h_jm1_kp1 = fh(i,aj_m1,ak_p1), h_jp1_kp1 = fh(i,aj_p1,ak_p1), h_jp2_kp1 = fh(i,aj_p2,ak_p1);
    double r_fyz_2 = (h_jm2_kp1 - F8*h_jm1_kp1 + F8*h_jp1_kp1 - h_jp2_kp1);
    double h_jm2_kp2 = fh(i,aj_m2,ak_p2), h_jm1_kp2 = fh(i,aj_m1,ak_p2), h_jp1_kp2 = fh(i,aj_p1,ak_p2), h_jp2_kp2 = fh(i,aj_p2,ak_p2);
